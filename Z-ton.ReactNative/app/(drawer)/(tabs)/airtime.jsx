...
import AirtimeFailureModal from '../../../components/airtime/airtime-failure-modal';
              ...
              //  Alert.alert("Transaction Failed", responseData.message || "Unable to complete purchase.");
                  ...
                  const data = err.response?.data;
                   ...
                   if (data?.errors) { // check if there are validation errors in the response
                    ...
                    // For other types of errors (e.g. insufficient balance, provider issues), show the failure modal
                     Haptics.notificationAsync(Haptics.NotificationFeedbackType.Error);
                      setShowFailureModal(true);
